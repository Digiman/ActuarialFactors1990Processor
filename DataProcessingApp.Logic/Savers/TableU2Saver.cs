...
{
    public class TableU2Saver : BaseSaver
    {
        public void SaveToExcel(TableU2 table, string filename)
        {
            // generate data for report to insert in Excel file
            var data = CreateDataForExcel("TableU2", table);
        ...
        private ExcelFileData CreateDataForExcel(string tableName, TableU2 table)
        {
            ...
            // 2. Table headers.
            data.Headers = GetHeaders<TableU2Row>();
        ...
        public void SaveToJsonFile(string filename, TableU2 table)
        {
        ...
        public void SaveToTextFile(string filename, TableU2 result)
        {

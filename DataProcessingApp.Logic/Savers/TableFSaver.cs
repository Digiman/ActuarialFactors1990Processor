...
{
    public class TableFSaver : BaseSaver
    {
        public void SaveToExcel(TableF table, string filename)
        {
            // generate data for report to insert in Excel file
            var data = CreateDataForExcel("TableF", table);
        ...
        private ExcelFileData CreateDataForExcel(string tableName, TableF table)
        {
            ...
            // 2. Table headers.
            data.Headers = GetHeaders<TableFRow>();
        ...
        public void SaveToJsonFile(string filename, TableF table)
        {

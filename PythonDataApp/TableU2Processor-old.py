'''
Special processor for Table U(2) - read CSV file and create a new file with new proper data
'''
...
#rowsPerPage = 51; pages = round(row_count/rowsPerPage);
#print("Pages (calculated by rows per page):", pages)
